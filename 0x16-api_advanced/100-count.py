...
def count_words(subreddit_name, keyword_list, next_page_token='', keyword_dict={}):
    """
    ...
    if next_page_token is None:
        sorted_keywords = sorted(keyword_dict.items(), key=lambda x: (-x[1], x[0]))
    ...
    try:
        ...
        for post in hot_posts:
            ...
            lower_case_title_words = [word.lower() for word in title.split(' ')]
